...
def _get_F8(Teff):
    ...
    '''
    Teffs, F8, R, Z = np.loadtxt('/Users/ryancloutier/Research/RVInformation/RVFollowupCalculator/InputData/nature12419-s2.txt',
                                usecols=(2,3,4,5)).T
    g = np.log10(Z) <= 1.85
...
def _get_logRhk_OLD(Prot, Ms):
    ...
    # FGK star
        ...
        lRhk1, Prot1 = np.loadtxt('/Users/ryancloutier/Research/RVInformation/RVFollowupCalculator/InputData/Lovisetal2011_withoutBcycle.dat',
                                  usecols=(4,9)).T
        lRhk2, Prot2 = np.loadtxt('/Users/ryancloutier/Research/RVInformation/RVFollowupCalculator/InputData/Lovisetal2011_withBcycle.dat',
                                  usecols=(4,9)).T
...
def get_prot_kepler(Teff, seed=None):
    ...
    '''
    Teffs, Prots = np.loadtxt('/Users/ryancloutier/Research/RVInformation/RVFollowupCalculator/InputData/asu.tsv', skiprows=37).T
...
def draw_prot_empirical(Ms):
    ...
    '''
    if Ms > .6:
        B_Vs, Prots, Mss = np.loadtxt('/Users/ryancloutier/Research/RVInformation/RVFollowupCalculator/InputData/PizzolatoData.tsv',
                                      skiprows=35).T
    else:
...
def draw_age():
    ...
    '''
    ages, eages = np.loadtxt('/Users/ryancloutier/Research/RVInformation/RVFollowupCalculator/InputData/ExoplanetHostStarAges.tsv',
                             skiprows=37).T
